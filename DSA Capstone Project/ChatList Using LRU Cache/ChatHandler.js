...
// const= another keyword to declare a variable when you do not want to change the value of that variable for the whole program.
...
// creates a new Map object and assigns it to a property called hashmap of the object being created.
    this.hashmap = new Map();
// initializes a property called linked_list to null.
    this.linked_list = null;
//  assigns the chat_template argument to a property called chat_template of the object being created.
    this.chat_template = chat_template;
    this.chat_list = chat_list;
// creates a new Date object and assigns it to a variable called clock.
    let clock = new Date();
// assigns the hours property of the object being created to the hour component of the clock object.
...
// returns a formatted string representing the current time in hours and minutes.
// slice(-2) = method is used to get the last two characters of the string.
